...
Here is the example configuration YAML file with descriptions below. You can also find this [example config file](https://github.com/adminium/permify/blob/master/example.config.yaml) in Permify repo.
